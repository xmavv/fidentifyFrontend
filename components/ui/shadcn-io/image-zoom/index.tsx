...
export const ImageZoom = ({
  ...
  <div
    className={cn(
      ...
      '[&_[data-rmiz-btn-zoom]]:m-0 [&_[data-rmiz-btn-zoom]]:size-10 [&_[data-rmiz-btn-zoom]]:touch-manipulation [&_[data-rmiz-btn-zoom]]:appearance-none [&_[data-rmiz-btn-zoom]]:rounded-[50%] [&_[data-rmiz-btn-zoom]]:border-none [&_[data-rmiz-btn-zoom]]:bg-gray-950/70 [&_[data-rmiz-btn-zoom]]:p-2 [&_[data-rmiz-btn-zoom]]:text-white [&_[data-rmiz-btn-zoom]]:outline-offset-2 dark:[&_[data-rmiz-btn-zoom]]:bg-gray-50/70 dark:[&_[data-rmiz-btn-zoom]]:text-gray-950',
      '[&_[data-rmiz-btn-unzoom]]:m-0 [&_[data-rmiz-btn-unzoom]]:size-10 [&_[data-rmiz-btn-unzoom]]:touch-manipulation [&_[data-rmiz-btn-unzoom]]:appearance-none [&_[data-rmiz-btn-unzoom]]:rounded-[50%] [&_[data-rmiz-btn-unzoom]]:border-none [&_[data-rmiz-btn-unzoom]]:bg-gray-950/70 [&_[data-rmiz-btn-unzoom]]:p-2 [&_[data-rmiz-btn-unzoom]]:text-white [&_[data-rmiz-btn-unzoom]]:outline-offset-2 dark:[&_[data-rmiz-btn-unzoom]]:bg-gray-50/70 dark:[&_[data-rmiz-btn-unzoom]]:text-gray-950',
  ...
  >
    <Zoom
      classDialog={cn(
        ...
        '[&_[data-rmiz-modal-overlay="visible"]]:bg-white/80 [&_[data-rmiz-modal-overlay="visible"]]:backdrop-blur-md dark:[&_[data-rmiz-modal-overlay="visible"]]:bg-gray-950/80',
