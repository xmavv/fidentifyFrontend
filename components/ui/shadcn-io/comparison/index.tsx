...
export const ComparisonHandle = ({
  ...
  return (
    ...
    >
      {children ?? (
        <>
          <div className="-translate-x-1/2 absolute left-1/2 h-full w-1 bg-white dark:bg-gray-950" />
          {mode === 'drag' && (
            <div className="z-50 flex items-center justify-center rounded-sm bg-white px-0.5 py-1 dark:bg-gray-950">
              <GripVerticalIcon className="h-4 w-4 select-none text-gray-500 dark:text-gray-400" />
            </div>
          )}
        </>
      )}
